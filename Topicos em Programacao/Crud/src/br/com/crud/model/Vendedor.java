...
public class Vendedor implements Serializable {
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "Vendedor_SEQ")
	@Column(name = "codigo")
	...
	@Column(name = "salario")
	@Resolvable(colName = "Salario")
	private Double salario;
	
	@Column(name = "filhos")
	@Resolvable(colName = "Filhos")
	private String filhos;
	
	@Column(name = "dataAdmissao")
	@Resolvable(colName = "Data de Admissão")
	private Date dataAdmissao;
	
	@Column(name = "dataDemissao")
	@Resolvable(colName = "Data de Demissão")
	private Date dataDemissao;
	
	@Column(name = "observacao")
	@Resolvable(colName = "Observações")
	private String obs;
