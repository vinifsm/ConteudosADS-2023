...
import br.com.crud.view.cadastro.TelaVenda;

public class TelaConsultaVenda extends JDialog {
	...
	private ObjectTableModel<Venda> model = null;// modelo da JTable
	 ...
	 */
	public TelaConsultaVenda(JFrame owner) {
		super(owner);
		initialize();
	}

	public TelaConsultaVenda(JDialog owner) {// construtor do formulario
		super(owner);
	...
	private void initialize() {
		...
		this.setTitle("Consulta de Vendas");
	...
	private void carregaTable(List lista) {
		...
		// por virgula sem espa�o.
		model = new ObjectTableModel<Venda>(resolver, "codigo,codProd.nome,codProd.valor");
		model.setData(lista);
	...
	private JButton getBtnCad() {
		if (btnCad == null) {
			...
			btnCad.addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					txtBusca.requestFocus();
					TelaVenda tela = new TelaVenda(TelaConsultaVenda.this);
					tela.setNovo(true);
