...
public class TelaConsultaBandeira extends JDialog {
	...
	private ObjectTableModel<BandeiraCartao> model = null;// modelo da JTable
	...
	private JLabel lbPainelConsulta;

	/**
	 * @wbp.parser.constructor
	 */
	public TelaConsultaBandeira(JFrame owner) {
		super(owner);
		initialize();
	}

	public TelaConsultaBandeira(JDialog owner) {// construtor do formulario
		super(owner);
	...
	private void initialize() {
		...
		this.setTitle("Consulta de Bandeira cartao");
		this.setSize(695, 433);
		// tamanho da tela
		...
		getJContentPane().add(getPainelConsulta());
	}
	...
	private void carregaTable(List lista) {
		...
		AnnotationResolver resolver = new AnnotationResolver(BandeiraCartao.class);
		// instancia o modelo da tabela, com os campos que ir� aparecer separado
		// por virgula
		model = new ObjectTableModel<BandeiraCartao>(resolver, "codigo,descricao,contaDescricao");
		model.setData(lista);
		...
		table.getColumnModel().getColumn(2).setPreferredWidth(253);
	...
	private JPanel getJContentPane() {
		...
		if (jContentPane == null) {
			...
			lbInformacao.setBounds(new Rectangle(10, 350, 497, 16));
			lbInformacao.setText("Enter/Dois cliques para selecionar");
			lbBusca = new JLabel();
			lbBusca.setBounds(new Rectangle(10, 92, 40, 20));
			lbBusca.setText("Buscar:");
			lbTotal = new JLabel();
			lbTotal.setHorizontalAlignment(SwingConstants.RIGHT);
			lbTotal.setBounds(new Rectangle(422, 323, 260, 16));
			lbTotal.setText("");
	...
	private JTextField getTxtBusca() {
		if (txtBusca == null) {
			...
			txtBusca.setToolTipText("Buscar Bandeira");
			txtBusca.setBounds(new Rectangle(50, 92, 369, 20));
		...
		if (table == null) {
			...
			table.addKeyListener(new java.awt.event.KeyAdapter() {
				...
				public void keyPressed(java.awt.event.KeyEvent e) {
					if (e.getKeyCode() == KeyEvent.VK_ENTER) {
						selecionar();
					} else if (e.getKeyCode() == KeyEvent.VK_A || e.getKeyCode() == KeyEvent.VK_B
							|| e.getKeyCode() == KeyEvent.VK_C || e.getKeyCode() == KeyEvent.VK_D
							|| e.getKeyCode() == KeyEvent.VK_E || e.getKeyCode() == KeyEvent.VK_F
							|| e.getKeyCode() == KeyEvent.VK_G || e.getKeyCode() == KeyEvent.VK_H
							|| e.getKeyCode() == KeyEvent.VK_I || e.getKeyCode() == KeyEvent.VK_J
							|| e.getKeyCode() == KeyEvent.VK_K || e.getKeyCode() == KeyEvent.VK_L
							|| e.getKeyCode() == KeyEvent.VK_M || e.getKeyCode() == KeyEvent.VK_N
							|| e.getKeyCode() == KeyEvent.VK_O || e.getKeyCode() == KeyEvent.VK_P
							|| e.getKeyCode() == KeyEvent.VK_Q || e.getKeyCode() == KeyEvent.VK_R
							|| e.getKeyCode() == KeyEvent.VK_S || e.getKeyCode() == KeyEvent.VK_T
							|| e.getKeyCode() == KeyEvent.VK_U || e.getKeyCode() == KeyEvent.VK_V
							|| e.getKeyCode() == KeyEvent.VK_X || e.getKeyCode() == KeyEvent.VK_Y
	...
	private JButton getBtnFechar() {
		if (btnFechar == null) {
			...
			btnFechar.setIcon(new ImageIcon(TelaConsultaBandeira.class.getResource("/br/com/crud/img/icons8-fechar-janela-30.png")));
			btnFechar.setFont(new Font("Tahoma", Font.PLAIN, 17));
			btnFechar.setBounds(new Rectangle(558, 350, 120, 35));
	...
	private JButton getBtnCad() {
		if (btnCad == null) {
			btnCad = new JButton();
			btnCad.setToolTipText("Cadastrar nova bandeira");
			btnCad.setFont(new Font("Tahoma", Font.PLAIN, 11));
			btnCad.setBounds(new Rectangle(553, 89, 125, 27));
			// btnCad.setIcon(new
			...
			btnCad.addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
					txtBusca.requestFocus();
					TelaBandeira tela = new TelaBandeira(TelaConsultaBandeira.this);
					tela.setNovo(true);
	...
	private JPanel getPainelConsulta() {
		if (painelConsulta == null) {
			...
			painelConsulta.setBackground(SystemColor.textHighlight);
			painelConsulta.setBounds(0, 0, 689, 68);
			painelConsulta.setLayout(null);
			painelConsulta.add(getLbPainelConsulta());
		}
		return painelConsulta;
	}
	private JLabel getLbPainelConsulta() {
		if (lbPainelConsulta == null) {
			lbPainelConsulta = new JLabel("Consulta de Bandeira");
			lbPainelConsulta.setForeground(Color.WHITE);
			lbPainelConsulta.setFont(new Font("Tahoma", Font.PLAIN, 32));
			lbPainelConsulta.setBounds(186, 11, 307, 43);
		}
		return lbPainelConsulta;
	}
}
